      ...
      <main className="relative z-10 mx-auto flex max-w-3xl flex-col items-center gap-10 px-6 pb-24 pt-28 text-center sm:pt-32">
        ...
        <div className="mx-auto w-full max-w-2xl rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur supports-[backdrop-filter]:bg-white/10 sm:p-8">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Link
              href="/web3"
              className="group inline-flex items-center justify-center gap-2 rounded-xl border border-violet-300/30 bg-white/0 px-5 py-4 text-base font-medium text-violet-200 shadow-lg shadow-violet-500/10 transition hover:-translate-y-0.5 hover:bg-violet-400/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300 sm:text-lg"
            >
              <span>Web3 (ERC‑20)</span>
              <span className="transition-transform group-hover:translate-x-0.5">🧩</span>
            </Link>
          </div>
